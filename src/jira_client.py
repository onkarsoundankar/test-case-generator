...
def fetch_story_from_jira(issue_key: str):
    ...
    # Jira Cloud stores description as Atlassian Document Format (ADF); extract plain text.
    description = fields.get("description")
    description_text = _extract_text_from_adf(description) if description else ""
